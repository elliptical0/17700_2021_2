...
public class Constants {
     ...
     *
     */
    public static final double[] LAUNCH_AIM_POSITIONS = {0.4, 0.2525};
    ...
    public static final double FLYWHEEL_MAX_RPM = 800;
    ...
    public static final String BUILD_NAME = "v0.15.1";
}